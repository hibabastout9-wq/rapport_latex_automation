...
\jury{
    \hspace{0.5cm}$\blacktriangleright$ Mme. xxxxx (EHTP) \dotfill Présidente\\[0.1cm]
    \hspace{0.5cm}$\blacktriangleright$ M. xxxxx (EHTP) \dotfill Rapporteur\\[0.1cm]
    \hspace{0.5cm}$\blacktriangleright$ M. xxxxx (CID Développement) \dotfill Examinateur
}
...
% --- TROISIÈME PARTIE : DESCRIPTION D'OPENFOAM ---
\part{TROISIÈME PARTIE : DESCRIPTION D'OPENFOAM, STRUCTURES, ALGORITHMES ET OUTILS}

\input{chapters/6_structure_code_cfd}
\input{chapters/7_structure_openfoam}
