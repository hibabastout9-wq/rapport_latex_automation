...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/figure4_location.png}
    \caption{Localisation du barrage Ahl Souss (A\"it M'zal) sur l'oued Izig, province de Chtouka A\"it Baha.}
...
\begin{itemize}
    ...
    \item \textbf{Longueur de déversement} : 75 m.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/figure4_coupe.png}
    \caption{Coupe transversale du barrage Ahl Souss (BCR) avec localisation de l'évacuateur de crues et de la vidange de fond.}
    \label{fig:coupe_barrage}
\end{figure}
